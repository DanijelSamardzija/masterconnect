/*
  # Fix blocker column name in get_feed_with_ranking function

  1. Changes
    - Update get_feed_with_ranking function to use correct column name
    - Change blocker_id to blocker_user_id (matches blocks table schema)

  2. Details
    - The blocks table uses blocker_user_id and blocked_user_id
    - Function was incorrectly referencing blocker_id
*/
