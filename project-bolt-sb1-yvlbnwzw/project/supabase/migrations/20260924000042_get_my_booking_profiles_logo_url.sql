-- Migration 042: Add logo_url to get_my_booking_profiles
-- Tradespeople use logo_url for their profile image; appointment types use avatar_url.
...
GRANT EXECUTE ON FUNCTION public.get_my_booking_profiles() TO authenticated, service_role;
