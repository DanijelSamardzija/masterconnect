-- Add completed_count (only 'completed' status) to get_business_service_stats_by_location.
-- Previously total_count mixed completed+no_show; completed_count is now separate and precise.
