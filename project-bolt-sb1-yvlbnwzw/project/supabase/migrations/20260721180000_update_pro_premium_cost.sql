-- Update PRO Premium price from 200 to 500 credits.
-- PRO Premium is a one-time lifetime purchase; the higher price better reflects
-- the value of lifetime PRO status (receive donations, analytics, premium badge).
