-- Add can_reschedule_bookings to update_staff_permissions.
-- The original migration only had 4 keys; this one adds the 5th
-- so it is no longer silently dropped when the owner saves permissions.
