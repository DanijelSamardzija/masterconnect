-- Update feed ranking function to include views_count in score and output
  ...
  scored_posts AS (
    SELECT
      ...
      (
        ...
        +
        -- Views: 0.3 pts each, capped at 30 pts total
        ...
        END
        -
        -- Age penalty (max 60 points, reached after ~100 hours)
