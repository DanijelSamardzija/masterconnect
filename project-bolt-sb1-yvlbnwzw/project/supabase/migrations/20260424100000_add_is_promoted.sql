...
GRANT EXECUTE ON FUNCTION get_feed_with_engagement_score(uuid, text, text, integer, integer, timestamptz, text, text) TO authenticated;
GRANT EXECUTE ON FUNCTION get_feed_with_engagement_score(uuid, text, text, integer, integer, timestamptz, text, text) TO anon;
