                      ...
                      {loc.phone && (
                        <span className="flex items-center gap-1.5 text-xs text-muted-foreground">
                          ...
                          <a
                            ...
                            rel="noopener noreferrer"
                            title="WhatsApp"
                            className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#25D366]/15 hover:bg-[#25D366]/30 text-[#25D366] transition-colors"
                          >
                          ...
                          <a
                            ...
                            title="Viber"
                            className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#7B519D]/15 hover:bg-[#7B519D]/30 text-[#7B519D] transition-colors"
                          >
                            <svg viewBox="0 0 24 24" className="w-3 h-3" fill="currentColor">
