              ...
              {stays.map((stay) => {
                ...
                return (
                  <div key={stay.id} className="border border-border rounded-xl p-4 bg-card flex flex-col gap-2">
                      ...
                      <div>
                        ...
                        {stay.client_phone && (
                          <span className="flex items-center gap-1.5 text-sm">
                            ...
                            <a href={`https://wa.me/${stay.client_phone.replace(/\D/g,'')}`} target="_blank" rel="noopener noreferrer" title="WhatsApp" className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#25D366]/15 hover:bg-[#25D366]/30 text-[#25D366] transition-colors">
                            ...
                            <a href={`viber://chat?number=${stay.client_phone.replace(/\D/g,'')}`} title="Viber" className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[#7B519D]/15 hover:bg-[#7B519D]/30 text-[#7B519D] transition-colors">
                    ...
                    {stay.notes && <p className="text-sm text-muted-foreground italic">{stay.notes}</p>}
