                    ...
                    <div className="border-t border-border bg-muted/30 px-4 pb-4 pt-3 flex flex-col gap-3">
                      ...
                      {req.client_phone && (
                        <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
                          ...
                          <a href={`https://wa.me/${req.client_phone.replace(/\D/g,'')}`} target="_blank" rel="noopener noreferrer" title="WhatsApp" className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#25D366]/15 hover:bg-[#25D366]/30 text-[#25D366] transition-colors">
                          ...
                          <a href={`viber://chat?number=${req.client_phone.replace(/\D/g,'')}`} title="Viber" className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#7B519D]/15 hover:bg-[#7B519D]/30 text-[#7B519D] transition-colors">
