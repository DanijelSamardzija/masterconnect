    ...
    user ? (
      <div className="flex gap-1.5 w-full">
        ...
        <a
          ...
          title="WhatsApp"
          className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#25D366]/15 hover:bg-[#25D366]/30 text-[#25D366] transition-colors shrink-0"
        >
        ...
        <a
          ...
          title="Viber"
          className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#7B519D]/15 hover:bg-[#7B519D]/30 text-[#7B519D] transition-colors shrink-0"
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
